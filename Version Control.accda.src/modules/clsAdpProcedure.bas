...
Private Function IDbComponent_DateModified() As Date
    IDbComponent_DateModified = m_SProc.DateModified
End Function
...
Public Function IDbComponent_SourceModified() As Date
    IDbComponent_SourceModified = GetSQLObjectModifiedDate(m_SProc.Name, estStoredProcedure)
End Function
...
Private Property Get IDbComponent_BaseFolder() As String
    IDbComponent_BaseFolder = IDbComponent_Options.GetExportFolder & "procedures\"
End Property
